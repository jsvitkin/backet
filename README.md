...
```bash
pipx install https://github.com/jsvitkin/backet/releases/download/v0.1.12/backet-0.1.12-py3-none-any.whl
```
...
py -3 -m pipx install https://github.com/jsvitkin/backet/releases/download/v0.1.12/backet-0.1.12-py3-none-any.whl
```
...
```bash
scripts/smoke-install.sh dist/backet-0.1.12-py3-none-any.whl "$PWD"
```

On native Windows PowerShell, validate the built wheel with `pipx`:

```powershell
py -3 -m pipx install --force .\dist\backet-0.1.12-py3-none-any.whl
backet --version
