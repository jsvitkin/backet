...
- Rules questions use query planning, hybrid retrieval, reranking metadata, and evidence checks before answer synthesis.
- Bot answers are source-grounded, answerability-aware, and include diagnostics for missing evidence, ambiguity, fallback, and degraded runtime state.
