...
The current release is `v0.1.25`.
...
```bash
curl -fsSL https://raw.githubusercontent.com/jsvitkin/backet/main/scripts/install.sh | bash -s -- --version 0.1.25
```
...
```bash
pipx install --python /path/to/python3.11 https://github.com/jsvitkin/backet/releases/download/v0.1.25/backet-0.1.25-py3-none-any.whl
```
