...
def test_setup_files_installs_private_deploy_workflow_and_assets(runner, tmp_path: Path) -> None:
    ...
    assert "backet[bot] @ https://github.com/jsvitkin/backet/releases/download/v0.1.23/backet-0.1.23-py3-none-any.whl" in workflow
    assert "backet[bot] @ https://github.com/jsvitkin/backet/releases/download/v0.1.23/backet-0.1.23-py3-none-any.whl" in dockerfile
    state = load_or_initialize_setup_state(vault)
